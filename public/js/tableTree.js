function tableTree(){
    layui.config({
        base: 'layui-v2.5.6/layui/tableTree/'
    }).extend({
        ...
        var treeTable = tableTree.render({
            elem: '#tableId'
            ,id:'tableTree'
            ,url:'layui-v2.5.6/layui/tableTree/json/data.json'
            ,height: 'full-90'
            ,page: true
            ,treeConfig:{ //表格树所需配置
            ...
            ,cols: [[
                {type:'checkbox'}
                ,{field:'id',title:'title',width:120,sort:true}
                ,{field:'name',title: '标题',width:259}
                ,{field:'state',align:'center',event:'state'
                    // ,config:{type:'button',name:"点击"}
                    ,title: '按钮',width:120,templet:'#selectStates1',
                }
